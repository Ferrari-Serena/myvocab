...
import type { Translation, Phrase, Sentence } from '../types'
...
interface WordCardProps {
  ...
  onDontKnow: (word: string, us: string, uk: string, translations: Translation[], phrases: Phrase[], sentences: Sentence[]) => void
}
...
export const WordCard = ({
  ...
  const handleDontKnow = () => {
    onDontKnow(word, us, uk, translations, phrases, sentences)
  }
  ...
  return (
    <Card>
      ...
      <div style={{ textAlign: 'center', marginTop: '20px' }}>
        <Button onClick={handleDontKnow}>加入生词本</Button>
      </div>
    </Card>
  )
}
